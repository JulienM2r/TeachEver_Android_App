...
import um2.ips.teachever.Events.OnClickListenerUserLogin;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countRecords();
        Button buttonEleveLogin = (Button) findViewById(R.id.buttonEleveLogin);
        buttonEleveLogin.setOnClickListener(new OnClickListenerUserLogin());
